...
DIAGNOSIS_PROMPT_SUFFIX = (
    "\n; If the CURRENT goal is not a theorem of the given axioms "
    ...
    "output no forall between ; Output begin and ; Output end, and write one line:\n"
...
def tree_status_from_child_data(failed_data: Optional[dict]) -> Tuple[str, str]:
    """Map a child's failed_lemmas.json to tree status + reason (no ATP hints)."""
    data = failed_data or {}
